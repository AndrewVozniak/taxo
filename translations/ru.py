dataset = {
    ...
    "charity": {
        "passenger": "Лучшая благодарность для нас - репост и рассказ друзьям о нашем сервисе.\n\n",
        "driver": "Лучшая благодарность для нас - репост и рассказ друзьям о нашем сервисе.\n\n"
                  "Если вы хотите поддержать нас финансово, вы можете сделать это, отправив любую сумму на наш "
                  "благотворительный кошелек:\n{charity_wallet}\n\n Или предоставив нам обратную связь",
        "send_feedback": "Отправьте ваше сообщение:",
        "feedback_sent": "Спасибо за ваше сообщение!",
    },
    ...
    "leave_rating": {
        ...
        "success": "Спасибо за использование нашего сервиса!",
    },
    ...
    "admin": {
        "you_being_admin": "Вы стали администратором.",
        "you_already_admin": "Вы уже администратор.",

        "get_feedbacks": {
            "no_feedbacks": "Обратная связь отсутствует.",
            "feedback": "Обратная связь от пользователя #{id}:\n\n{feedback}",
        },

        "delete_feedback": {
            "success": "Обратная связь успешно удалена.",
        },

        "publish_ad": {
            "send_image_and_text": "Отправьте фотографию и текст",
            "send_start_date": "Отправьте дату начала",
            "send_end_date": "Отправьте дату окончания",
            "use_format": "Используйте формат дд.мм.гггг чч:мм",
            "ad_published": "Объявление опубликовано."
        },

        "change_charity_wallet": {
            "message": "Введите благотворительный кошелек:",
            "success": "Благотворительный кошелек успешно изменен.",
        },

        "change_ad_interval": {
            "message": "Введите интервал объявлений (в часах):",
            "success": "Интервал объявлений успешно изменен.",
    ...
    "keyboards": {
        ...
        "change_charity_wallet": "💰 Изменить благотворительный кошелек",
        "change_ad_interval": "📅 Изменить интервал объявлений",
        "feedback": "📩 Обратная связь",
        "get_feedbacks": "📩 Получить обратную связь",
